...
from sklearn.metrics import balanced_accuracy_score, accuracy_score, precision_score, recall_score, roc_curve, roc_auc_score
...
if __name__ == '__main__':
    ...
    for phylum in phylum_list:
        ...
        with open('./files/{}/{}-spearman-genome-size-{}.txt'.format(DATA, DATA, TYPE), 'a') as file:
