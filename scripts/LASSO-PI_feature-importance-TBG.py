...
if __name__ == '__main__':
    ...
    print('Loading data...')
    f = open('./files/cutoff_0.90/TBG/TBG-{}-by-phylum-{}-LASSO-metrics-SMOTE.log.txt'.format(SHUF, DATA), 'w+') #open log file
    curr_dir = os.getcwd()

    meta_file = curr_dir+'/data/TG_data/Tibetan_glacier_metadata_cultured_level.csv'
    path_file = curr_dir+'/data/TG_data/TBG_MAGs_COGs_pathway_count.csv'
    annot_file = curr_dir+'/data/TG_data/TBG_MAGs_COGs_annotation.csv'
...
#    print(data.shape)
    ...
    for phylum in phylum_list:
        ...
        features = features.loc[:, ~features.columns.isin([
                                                        ...
                                                        #'Num_tRNA', 
                                                        #'Quality_score', 
                                                        #'Quality_tier_standard(MIMAG，10.1038/nbt.3893)', 
                                                        #'GTDB_classification', 
                                                        #'kingdom', 
                                                        'domain',
                                                        'phylum', 
    ...
    full_df.to_csv(curr_dir+'/files/cutoff_0.90/TBG/TBG-{}-bootstrapped-by-phylum-{}-LASSO-stats-SMOTE.csv'.format(SHUF, DATA))
